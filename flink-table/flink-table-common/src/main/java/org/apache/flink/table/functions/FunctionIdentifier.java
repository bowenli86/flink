...
/**
 * Identifies a temporary or catalog function. An identifier must be fully qualified.
...
public final class FunctionIdentifier implements Serializable {
	...
	private FunctionIdentifier(ObjectIdentifier objectIdentifier){
		this.objectIdentifier = checkNotNull(objectIdentifier, "Object identifier cannot be null");
		functionName = null;
	}
